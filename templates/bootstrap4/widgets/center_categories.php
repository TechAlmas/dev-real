                ...
                <div class="property-card-box card-box card-block">
                    ...
                    <ul class="treefield-categories">
                        ...
                        <li>
                            ...
                            <?php else:?>
                                <a href='<?php echo site_url($lang_code.'/'.$this->data['page_id'].'/?search={"v_search_option_'.$treefield_id.'":"'.rawurlencode($item['title_chlimit'].' - '.$child['title'].' - ').'"}'); ?>' class="treefield-box-item btn-default"><?php _che($child['title']); ?></a>
                            <?php endif;?>
