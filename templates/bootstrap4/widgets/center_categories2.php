                    ...
                    <div class="property-card-box card-box classfied-card-box-category">
                        <div class="treefield-categories clearfix">
                            <?php if (count($item['childs_8']) > 0) foreach ($item['childs_8'] as $child): ?>
                                ...
                                <?php else:?>
                                    <a href='<?php echo site_url($lang_code.'/'.$this->data['page_id'].'/?search={"v_search_option_'.$treefield_id.'":"'.rawurlencode($item['title_chlimit'].' - '.$child['title'].' - ').'"}'); ?>' class="treefield-box-item btn-default"><?php _che($child['title']); ?>  (<?php _che($child['count']);?>)</a>
                                <?php endif;?>
                            <?php endforeach; ?>
                        </div>
                    </div>
