    ...
    <div class="container">
        <div class="row-fluid">
            ...
            <?php endif;?>
                ...
                <?php if(file_exists(APPPATH.'controllers/admin/showroom.php')):?>
                <div class="new-list property_content_position" id="showroom" >
            ...
            <div class="span3">
                <div class="panel">
                    <h3 class="main-heading bottom-line "><span class="main-circle-icon"><i class="icon-search"></i></span><?php _l('Search');?></h3>   
                    <input id="search_showroom" type="text" placeholder="" name="" value="" class="input-block-level" required=""/>
                    ...
                    <div class="accordion">
                        <div class="accordion-group">
                            ...
                            <div class="accordion-heading">
                                <a class="accordion-toggle" href="{page_current_url}?cat=<?php echo $id; ?>#showroom"><?php echo $category_name; ?></a>
                            </div>
                            <?php endif;?>
                            <?php endforeach;?>
                        </div>
