...
<div class="panel panel-default panel-sidebar-1  bottom-line line-before">
    <div class="panel-heading bottom-line  line-before main-heading"><h3><?php _l('Currency conversions'); ?></h3></div>
<div class="panel-body text-center currency_widget">
    <table class="table table-striped">
        <tr>
            <td><input id="ccw_value" class="input-block-level currency_value" name="currency_value" type="text" value="<?php echo $default_value; ?>" /></td>
            <td>
<?php
$CI =& get_instance();
...
echo form_dropdown('currency_code', $options, $default_currency, 'id="ccw_code" class="input-block-level"');
?>
            </td>
        </tr>
