<h2 class="main-heading bottom-line"><span class="main-circle-icon"><i class="icon-building"></i></span> <?php _l('Recent Properties');?> : <span id="count_row"> <?php echo $total_rows; ?></span></h2>   
<div class="featured-grid right-space results_conteiner">
<div class="properties-rows">
    <div class="filter">
        <form class="form-horizontal" method="get" action="?">
            <a style="display:none;" class="view-type active <?php _che($view_grid_selected); ?>" ref="grid" href="#"><img src="assets/img/glyphicons/glyphicons_156_show_thumbnails.png" /></a>
