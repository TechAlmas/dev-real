...
<div class="form-group <?php echo $class_add; ?>" style="<?php _che($field->style); ?>">
    <label class="checkbox" for="search_option_<?php echo $f_id; ?>">
        <input rel="<?php _che(${'options_name_'.$f_id}); ?>" name="search_option_<?php echo $f_id; ?>" id="search_option_<?php echo $f_id; ?>" type="checkbox" value="true<?php _che(${'options_name_'.$f_id});?>" <?php echo search_value($f_id, 'checked'); ?>/> <?php _che(${'options_name_'.$f_id}); ?>
    </label>
</div><!-- /.form-group -->