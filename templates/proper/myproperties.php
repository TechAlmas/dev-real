...
<body class="<?php _widget('custom_paletteclass'); ?>">
   <!-- Start Wrapper-->
    ...
    <div class="container" id="main">
        ...
        <div class="row-fluid">
            <div class="span12">
            <h2  id="expert" class=" home-page-body main-heading bottom-line"> {lang_Myproperties}</h2>   
            <div class="property_content">
                <div class="widget-controls"> 
                    ...
                    <?php if(file_exists(APPPATH.'controllers/admin/booking.php')):?>
                        <?php echo anchor('rates/payments/'.$lang_code.'#content-main', '<i class="icon-book"></i>&nbsp;&nbsp;'.lang_check('Payments received'), 'class="btn btn-primary pull-right"')?>
