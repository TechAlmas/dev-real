...
class Frontend extends Frontend_Controller
{
    ...
    private function load_head_data()
    {
        ...
        foreach($options_name as $key=>$row)
        {
            ...
            if(is_countable(explode(',', $row->values)) && count(explode(',', $row->values)) > 0)
            {
    ...
    public function edit_visit()
    {
        ...
        if($id)
        {
            ...
            if(is_countable($this->data['listing']) && count($this->data['listing']) == 0)
            {
                $this->session->set_flashdata('error', 
    ...
    public function editrate()
    {
	    ...
	    if($id)
        {
            if(is_countable($this->data['rate'])){
    ...
    public function deleteproperty()
    {
	    ...
	    if($id)
        {
            ...
            if(is_countable($this->data['estate']) && count($this->data['estate']) > 0)
            {
                //Check if user have permissions
...
//            exit();
        ...
        if(is_countable($news_category) && count($news_category)>0)
        {
        ...
        $cat_merge = array();
        if(is_countable($showroom_category) && count($showroom_category)>0)
        {
        ...
        $cat_merge = array();
        if(is_countable($expert_category) && count($expert_category)>0)
        {
