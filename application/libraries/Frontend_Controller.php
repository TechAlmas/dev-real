...
//        header("Connection: close");
       ...
       // Extra JS features enabled
        ...
        if($this->uri->uri_string() == '' && is_countable($this->language_m->db_languages_code) && count($this->language_m->db_languages_code) > 0)
        {
...
//            exit();
        ...
        {
            if(is_countable($this->data['not_logged']) && count($this->data['not_logged']) > 0 && $this->uri->segment(2) != 'login')
            {
